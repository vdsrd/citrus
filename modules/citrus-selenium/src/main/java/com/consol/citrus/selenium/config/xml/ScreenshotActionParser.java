...
import com.consol.citrus.selenium.action.ScreenshotAction;

/**
 * @author VASCO Data Security
 * @since 2.7
 */
public class ScreenshotActionParser extends AbstractWebActionParser {
    ...
    protected void doParse(Element element, BeanDefinitionBuilder builder) {
        builder.addPropertyValue("testcaseStep", element.getAttribute("step"));
    }
