...
import com.consol.citrus.selenium.action.GotoFrameAction;

/**
 * @author VASCO Data Security
 * @since 2.7
 */
public class GotoFrameActionParser extends AbstractWebActionParser {
    ...
    protected void doParse(Element element, BeanDefinitionBuilder builder) {
        String frame = element.getAttribute("frame").trim();
        if (StringUtils.hasText(frame)) {
            BeanDefinitionParserUtils.setPropertyValue(builder, frame, "frame");
        }
    }
