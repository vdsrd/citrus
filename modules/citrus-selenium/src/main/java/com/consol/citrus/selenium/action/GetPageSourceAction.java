...
/**
 * Action to resolve the page source.
 * 
 * @author VASCO Data Security
 * @since 2.7
 */
public class GetPageSourceAction extends AbstractWebAction {
    ...
    public void doExecute(TestContext context) {
        context.setVariable(varName, webClient.getBrowser().getPageSource());
    }
