...
import com.consol.citrus.selenium.action.GetPageSourceAction;

/**
 * @author VASCO Data Security
 * @since 2.7
 */
public class GetPageSourceActionParser extends AbstractWebActionParser {
    ...
    protected Class<? extends AbstractWebAction> getActionClass() {
        return GetPageSourceAction.class;
    }
}
