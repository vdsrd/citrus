...
import com.consol.citrus.selenium.action.GetCookieAction;

/**
 * @author VASCO Data Security
 * @since 2.7
 */
public class GetCookieActionParser extends AbstractWebActionParser {
