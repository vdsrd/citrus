...
import com.consol.citrus.selenium.action.DelCookieAction;

/**
 * @author VASCO Data Security
 * @since 2.7
 */
public class DelCookieActionParser extends AbstractWebActionParser {
