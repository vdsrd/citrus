...
/**
 * Action to verify the URL path.
 * 
 * @author VASCO Data Security
 * @since 2.7
 */
public class VerifyUrlAction extends AbstractWebAction {
    ...
    public void doExecute(TestContext context) {
        webClient.getBrowser().verifyPageURL(path);
    }
    
    /**
     * @param path URL path to be verified.
     */
