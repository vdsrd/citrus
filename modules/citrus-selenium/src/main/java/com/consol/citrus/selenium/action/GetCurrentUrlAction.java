...
/**
 * Action to revolve the current URL.
 * 
 * @author VASCO Data Security
 * @since 2.7
 */
public class GetCurrentUrlAction extends AbstractWebAction {
    ...
    public void doExecute(TestContext context) {
        context.setVariable(varName, webClient.getBrowser().getCurrentUrl());
    }
