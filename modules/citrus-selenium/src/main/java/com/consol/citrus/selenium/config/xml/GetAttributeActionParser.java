...
import com.consol.citrus.selenium.action.GetAttributeAction;

/**
 * @author VASCO Data Security
 * @since 2.7
 */
public class GetAttributeActionParser extends AbstractWebActionParser {
    ...
    protected void doParse(Element element, BeanDefinitionBuilder builder) {
        ...
        String attribute = element.getAttribute("attribute").trim();
        BeanDefinitionParserUtils.setPropertyValue(builder, attribute, "attribute");
    ...
    protected Class<? extends AbstractWebAction> getActionClass() {
        return GetAttributeAction.class;
    }
}
